...
frauds = np.concatenate((mappings[(7,4)], mappings[(8,1)]), axis = 0)
#frauds = mappings[(7,1)]
...
y_pred = np.concatenate((dataset.iloc[:, 0:1].values, y_pred), axis = 1)    # horizontal concatenation - axis = 1
